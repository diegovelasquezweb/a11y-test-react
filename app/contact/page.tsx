  ...
  return (
    <div>
      ...
      <form className="flex flex-col gap-3 max-w-md">
        ...
        <input id="name" type="text" placeholder="Your name" className="border rounded p-2" aria-labelledby="name" />
        ...
        <textarea id="message" placeholder="Your message" className="border rounded p-2" aria-labelledby="message" />
        <button type="submit" className="bg-1a5ccc text-white rounded p-2">Send</button>
      </form>
    </div>
  );
}
