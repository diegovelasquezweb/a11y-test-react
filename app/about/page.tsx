export default function About() {
  return (
    <div>
      ...
      <p className="mb-4">
        Read more on the{" "}
        <a href="https://www.w3.org/WAI/" target="_blank" rel="noopener noreferrer" aria-label="W3C WAI website (opens in new tab)">W3C WAI website</a>.
      </p>
      ...
      <iframe title="Example website embed" src="https://example.com" width="300" height="200" className="mb-4"></iframe>
