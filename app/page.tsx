export default function Home() {
  return (
    <main className="mx-auto max-w-3xl space-y-8 p-8">
      ...
      <input type="radio" name="opt" aria-checked="mixed" aria-label="Option" />

      {/* aria-deprecated-role: role="directory" está deprecado en ARIA, reemplazado por role="list" */}
      ...
      <input type="text" aria-label="Enter text" className="rounded border px-2 py-1" />
