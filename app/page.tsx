export default function Home() {
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="https://placehold.co/150x100" className="block" alt="Placeholder decorative image" width={150} height={100} />
      ...
      <object data="https://example.com/doc.pdf" width="300" height="200" aria-label="Document PDF"></object>
      ...
      <p className="static-announcement">Important announcement</p>
