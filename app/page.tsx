export default function Home() {
  return (
    <main className="mx-auto max-w-3xl space-y-8 p-8">
      ...
      <span role="button" tabIndex={0} className="inline-block cursor-pointer rounded bg-slate-200 px-3 py-1">Click me</span>

      {/* aria-conditional-attr: aria-checked="mixed" no está permitido en role radio */}
      <label htmlFor="radioOpt" className="inline-flex items-center">
        <input id="radioOpt" type="radio" name="opt" className="mr-2" />
        <span>Option</span>
      </label>

      {/* aria-deprecated-role: role="directory" está deprecado en ARIA */}
      <ul className="rounded border p-2">
        <li>Legacy directory listing</li>
      </ul>
      ...
      <label htmlFor="textInput" className="block text-sm font-medium mb-1">Text input</label>
      <input id="textInput" type="text" className="rounded border px-2 py-1" />
